...
* 
*  \file MoveAction.cpp
*  \brief implements the (goto_waypoint) action
*
*  \author Zoe Betta
*  \version 1.0
*  \date 22/03/2022
...
* dispatches the action (goto_waypoint). It moves the robot to the desired waypoint.
*/
 ...
 * the action goto_waypoint. It reads the desired waypoints and depending on that
